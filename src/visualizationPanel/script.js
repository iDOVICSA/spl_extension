...
(function () {
    ...
    window.addEventListener('message', event => {
        ...
        switch (message.command) {
            ...
            const Colors =['#f94144', '#f3722c', '#90be6d', '#43aa8b','#577590','#001f54','#7d4f50','#f7aef8','#f700f8','#f7aef8','#f7aef8'];
            ...
            var title = document.createElement("div");
            title.setAttribute("class", "title");
            title.innerText = "FCA Constraints Discovery";
            constraint.appendChild(title);

            var constraint2 = document.createElement("div");
            var title = document.createElement("div");
            title.setAttribute("class", "title");
            title.innerText = "FpGrowth Constraints Discovery";
            constraint2.appendChild(title);
