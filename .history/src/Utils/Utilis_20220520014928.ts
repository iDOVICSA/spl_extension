...
export class Utils {
    ...
    static showBlocDetails(b: Block) {
        let variantTitle = "";
        let txt = "";
        b.sourceCodeContent.forEach((elementRange: vscode.Range[], element: Element) => {
        ...
        b.sourceCodeContent.forEach(eR => {
            variantTitle = variantTitle + eR.
                eR.forEach(e => {
