...
export class FpGrowthConstraintsDiscovery {
    ...
    adaptMapOfVariantsToListOfVariants(blocksByVariant: Map<number, number[]>): any {
        let transactions: number[][];
        console.log("Adapt me !!!!!!!!!!!!!");
        console.log(blocksByVariant);
        blocksByVariant.forEach((value: number[], key: number) => {
            console.log("new value cheikh");
            console.log(value);
    ...
    getRequireConstraints(blocksByVariant: Map<number, number[]>) {
        ...
        console.log("salem 3likom cv labes");
        const transactions = this.adaptMapOfVariantsToListOfVariants(blocksByVariant);
