...
export class Utils {
    ...
    static getSharedParentOfAltGroup(reqConstraint: Constrainte[], altGroup: AltGroup, parentCondidate: Map<number, Feature>) {

        parentCondidate.forEach(requiredFeature => {
