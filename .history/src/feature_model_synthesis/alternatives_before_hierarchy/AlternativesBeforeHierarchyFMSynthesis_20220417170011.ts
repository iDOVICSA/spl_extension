...
export class AlternativesBeforeHierarchyFMSynthesis {
    ...
    public createFeatureModel() {
        ...
        this.listOfFeatures.forEach(f => {
            ...
            // feature inside an alt group we search for intersection between 
            // parentCondidate and parent for all the alt group
            if (altGroup) {
                parentCondidate = Utils.getSharedParentOfAltGroup(this.reqConstraints, altGroup, parentCondidate);
            }
