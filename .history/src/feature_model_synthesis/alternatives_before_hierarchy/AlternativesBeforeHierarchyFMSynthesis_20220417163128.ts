...
export class AlternativesBeforeHierarchyFMSynthesis {
    ...
    public createFeatureModel() {
        ...
        this.listOfFeatures.forEach(f => {
            ...
            let altGroup: AltGroup | undefined = altGroupList.getAltGroupOfFeature(f);
            let parentCondidate: Map<number, Feature> = new Map<number, Feature>();

            console.log(Utils.getFeatureRequiredFeatures(this.reqConstraints, f, this.listOfFeatures));
