...
export class Utils {
    ...
    static exportAlternativesBeforeHierarchyFMForgeJson(blocks: Block[], feature: Map<number, Feature>, requireConstraints: Constrainte[], mutexConstraints: Constrainte[], variantsCount: number) {
