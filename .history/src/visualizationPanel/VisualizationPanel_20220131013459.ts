...
export class VisualizationPanel {
	...
	public showVariants() {
		...
		const dataRerequireConstraintsFca = JSON.stringify(jsonObjectRerequireConstraintsFca);

		this._panel.webview.postMessage({
			command: 'showvariants', data: data, dataWordCloud: dataWordCloud, dataRerequireConstraintsFca: dataRerequireConstraintsFca
		});
	}
