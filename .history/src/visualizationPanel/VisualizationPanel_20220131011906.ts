...
export class VisualizationPanel {
	...
	public showVariants() {
		...
		console.log("shoooooooooooow variants IN");
		console.log(this.requireConstraintsFca);
		console.log("shoooooooooooow variants IN");
		console.log(this.exclusionConstraintsFca);
		console.log("shoooooooooooow variants IN");
		console.log(this.requireConstraintsFpGrowth);
