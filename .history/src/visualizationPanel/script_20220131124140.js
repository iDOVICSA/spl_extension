...
let rerequireConstraintsFcaIterable  =[];
               ...
               let jsonObject= JSON.parse(message.data); 
                ...
                iterable.set(value,jsonObject[value]) ;
                 ...
                 for (var value in jsonObjectWordCloud) {  
                  ...
                  for (var value in jsonObjectdataRerequireConstraintsFca) {  
                         rerequireConstraintsFcaIterable.push(jsonObjectdataRerequireConstraintsFca[value]);
                     }                
