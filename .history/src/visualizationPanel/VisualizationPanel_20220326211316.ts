...
export class VisualizationPanel {
	...
	public showVariants() {
		...
		this._panel.webview.postMessage({
			command: 'showvariants', data: data, dataRequireConstraintsFca: dataRequireConstraintsFca, dataExclusionConstraintsFca: dataExclusionConstraintsFca, dataRequireConstraintsFpGrowth: dataRequireConstraintsFca, dataListOfBlocks: dataListOfBlocks
		});
	}
