...
export class VisualizationPanel {
	...
	private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, blocksByVariant: Map<number, number[]> | undefined, blocksByVariant: Map<number, number[]> | undefined) {
		this._panel = panel;
