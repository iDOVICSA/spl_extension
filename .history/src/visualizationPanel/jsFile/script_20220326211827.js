...
(function () {
    ...
    function createConstraint(){
        ...
        dataRequireConstraintsFpGrowth.forEach(element => {
            var rerequireParagraph = document.createElement("div");
            rerequireParagraph.setAttribute("class","constraintDiscovery");
            rerequireParagraph.innerHTML = listOfBlocks.get(element.firstBlock.toString()).blockName  + " require KHO" +listOfBlocks.get(element.secondBlock.toString()).blockName ;
